...
//OBJETIVO 1 - quando passar o mouse em cima do personagem na listagem, devemos selecioná-lo
 ...
 personagens.forEach((personagem) => {
    ...
    personagemSelecionado.classList.remove('selecionado');
        //essa de baixo e uma parte do passo 2 porém em ordem tem que ficar após passo 3(pois primeiro remove depois seleciona) 
...
// passo 1 - pegar o elemento do personagem grande pra adicionar as informações nele
        ...
        //escolhi não re-fatorar para ajudar na minha apredizagem, quando precisar  volto para tirar alguma dúvida.
